...
At the initial stage, I used the c ++ programming language to solve some problems using the OMP parallel computing technology. I took part at five [conferences](conf.md), including international ones. I have [two articles] in print media indexed by SCOPUS.
